...
const databaseUrl = `https://raw.githubusercontent.com/razzxyahay/dbsc/refs/heads/main/token.json`;
  ...
  const thumbnailUrl = "https://files.catbox.moe/gqls66.jpg"; // FOTO PAS Kirim Bug
  
  const StartUrl = "https://files.catbox.moe/gqls66.jpg"; // FOTO PAS START
  
  const menuUrl = "https://files.catbox.moe/gqls66.jpg"; // FOTO MENU
  
  const bugUrl = "https://files.catbox.moe/gqls66.jpg"; // FOTO MENU BUG
  
  const toolsUrl = "https://files.catbox.moe/gqls66.jpg"; // FOTO TOOLS
  
  const tqtoUrl = "https://files.catbox.moe/gqls66.jpg"; // FOTO TQTO
  
  const attackUrl = "https://files.catbox.moe/gqls66.jpg"; // FOTO PAS BERES BUG
